...
ax.plot(Date, data['obsMaxTemp'], color='b', linewidth=1.5, label='max-turtle')
ax.plot(Date, data['obsMinTemp'], '--',color='b', linewidth=1.5, label='min-turtle')
ax.plot(Date, data['modMaxTemp'], color='r', linewidth=1.5, label='max-model')
ax.plot(Date, data['modMinTemp'], '--',color='r', linewidth=1.5, label='min-model')
plt.legend(loc=1,ncol=2,fontsize = 'x-small')
ax.set_xlabel('Time(2013)', fontsize=14)
