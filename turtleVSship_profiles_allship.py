...
for i in range(5):
    ax.bar(np.arange(1,13)+width*(i-3.75),Num[i],align="center",width=width,color=color[i] ,label=str(i+2009))
...
for i in range(5):
    ax1.bar(np.arange(1,13)+width*(i-3.75),Num1[i],align="center",width=width,color=color[i] ,label=str(i+2009))
plt.legend(loc='best',fontsize = 'x-small')
plt.xlim([1,13]) 
plt.ylim([0,1200])
